...
class VariantCreator:
        ...
        with open(labelled_csv, 'r', newline='') as csvfile:
            ...
            for row in reader:
                ...
                if(transform_state.flip):
                    print(f"Skipping {filename} because it is flipped, this script does not create flipped variants.")
                    continue
                ...
                # Create variants
                for i in range(10):  # Less variants to avoid overfitting
    ...
    def randomize_transform_and_color(self, image, transform_state):
        ...
        adjust_g = random.uniform(0.8, 1.3)
        adjust_b = random.uniform(0.8, 1.3)
        adjust_r = random.uniform(0.8, 1.3)
...
if __name__ == "__main__":
    ...
    output_dir = os.path.join(os.path.dirname(__file__), "../../image_bank/variants_2/")
    new_csv_path = "../../datasets/variants_labels_2.csv"
