...
if __name__ == "__main__":
    ...
    input_dir = os.path.join(os.path.dirname(__file__), "../image_bank", "stripped")  # Directory of input images
    output_dir = os.path.join(os.path.dirname(__file__), "../image_bank", "stripped")  # same if in place
    ...
    for filename in os.listdir(input_dir):
        if filename.endswith(".png"):
            ...
            processed_image = remover.remove_hidden_rgb(image)
